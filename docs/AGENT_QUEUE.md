...
**Branch(es) / PR(s):** `cursor/dormra-nightly-agent-queue-c22d` → main

### Summary

No tasks in queue. The Draft section had no dated bullets to process (last draft cleared 2026-07-04).
...
- None new. Add bullets under **Draft** when you have work for the next nightly run.
