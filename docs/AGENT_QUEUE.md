...
**Branch(es) / PR(s):** `cursor/dormra-nightly-agent-queue-c571` → main

### Summary

No tasks in queue. The Draft section has no dated bullets (cleared after 2026-07-04). No code changes required.
