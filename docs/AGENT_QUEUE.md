...
**Branch(es) / PR(s):** `cursor/dormra-nightly-agent-queue-7ebc` → main (no code changes)

### Summary

No tasks in queue. The Draft section has no dated bullets — last draft was cleared on 2026-07-04. No implementation work this run.
...
- Add new bullets under `## Draft — YYYY-MM-DD` when you have tasks for the night agent.
