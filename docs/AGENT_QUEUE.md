...
## Nightly report — 2026-07-25

**Branch(es) / PR(s):** `cursor/dormra-nightly-agent-queue-c91e` → main
...
- None from tonight's run (see [`docs/MANUAL_TASKS.md`](./MANUAL_TASKS.md) for open operator items from prior runs)
