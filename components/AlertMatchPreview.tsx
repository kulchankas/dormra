...
import { countMatches, type AlertCriteria } from '@/lib/alertMatch'
import type { Dorm } from '@/lib/helpers'

export default function AlertMatchPreview({ criteria }: { criteria: AlertCriteria }) {
    ...
    <div className="flex items-center gap-3 rounded-2xl border border-brand/20 bg-brand-soft/40 p-4">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Based on current listings · we&apos;ll alert you when new matches appear.
        </p>
      </div>
    </div>
  )
